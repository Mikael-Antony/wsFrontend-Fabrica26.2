  ...
  return (
    <>
      <section className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 p-2 md:p-4 w-fit">
        {heroes.map((hero) => (
          <Link key={hero.key} href={`/hero/${hero.key}`} className="zoom-80 sm:zoom-90 sm:hover:scale-120 opacity-75 hover:opacity-100 hover:scale-100 duration-300 flex flex-col items-center justify-center gap-2 p-4 bg-[#bbb] dark:bg-zinc-950 rounded-lg shadow-md">
