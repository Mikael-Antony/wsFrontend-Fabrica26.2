        ...
        <section className="flex flex-col gap-10 max-w-6xl">
          <div className="flex flex-col justify-center items-center gap-10">
            {hero.abilities.map((ability) => (
              <div key={ability.name} className="flex justify-between gap-5 items-center bg-gray-950 p-5 rounded-xl  hover:zoom-150 duration-500 ease-in-out w-fit">
          ...
          <div className="flex flex-col gap-10">
            ...
            <div className="flex flex-col gap-5">
              {hero.perks?.major.map((perk) => (
                <div key={perk.name} className="flex gap-2 bg-gray-950 p-2 w-fit rounded-xl hover:zoom-150 duration-500 ease-in-out">
